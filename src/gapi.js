...
(function() {
  ...
  var ca = -1 != n.indexOf("Opera"),
    ...
    w =
      -1 != n.indexOf("Gecko") &&
      !(-1 != n.toLowerCase().indexOf("webkit") && -1 == n.indexOf("Edge")) &&
      !(-1 != n.indexOf("Trident") || -1 != n.indexOf("MSIE")) &&
      -1 == n.indexOf("Edge"),
  ...
  fa =
    ha && v
      ? y() || ("CSS1Compat" == ha.compatMode ? parseInt(F, 10) : 5)
      : void 0;
  var I;
  if (!(I = !w && !v)) {
    var J;
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
  ...
  var Z = decodeURI("%73cript"),
    ...
    Ia = function() {
      var a = P.nonce;
      if (void 0 !== a)
        return a && a === String(a) && a.match(Ga) ? a : (P.nonce = null);
      var b = M(P, "us", []);
      ...
      if (e["::"] && b.length) {
        ...
        for (var f = null; (f = b.shift()); ) {
          ...
          var g = (a.length && a[a.length - 1]) || null,
            x = g;
          (g && g.hint == h) || ((x = { hint: h, b: [] }), a.push(x));
          x.b.push(f);
        }
        var A = a.length;
        if (1 < A) {
  ...
  _c: {
    jsl: {
      ci: {
        ...
        client: {
          cors: false,
          batchPath: { translate: "batch/translate" },
          perApiBatch: true
        },
        isLoggedIn: true,
      ...
      h:
        "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.yKRlBN1Ry_M.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCM-2JMsCoWm13gm6gJ86Qzt2sJfrw",
      u: "https://apis.google.com/js/api.js",
      hee: true,
      fp: "a0ff892455f0902b5ec8d1be46189e000c1d7e7b",
      dpo: false
    },
    fp: "a0ff892455f0902b5ec8d1be46189e000c1d7e7b",
    annotation: [
